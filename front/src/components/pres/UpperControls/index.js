...
class UpperControls extends Component {
  ...
  fetchData = () => {
    ...
    if (this.props.widthOutTab) return;
        ...
        <>
          ...
          {capitalize.words(
            this.state.selectedBrand
              ? this.state.selectedBrand.toLowerCase()
              : ""
          )}
        </>
      ) : (
        ...
        <div className={s.controlsContainer}>
          <Grid container style={{ paddingLeft: "30px", paddingRight: "30px" }}>
            ...
            <Grid item xs={5} className={s.gridItem}>
              <p className={s.dashboardLabel}> {title}</p>
            </Grid>
            {!this.props.widthOutTab && (
                  ...
                  >
                    ...
                    {this.props.brands.length !== 0
                      ? this.props.brands.map((brand) => (
                          <MenuItem
                            key={brand.id}
                            value={brand.brand_name.toUpperCase()}
                          >
